...
namespace Storm\Drivers\Pinq\Object\Functional\PHPParser\Visitors;
...
class FunctionLocatorVisitor extends \PHPParser_NodeVisitorAbstract {
    ...
    private function FoundFunctionNode(\PHPParser_Node $Node) {
        if($this->HasLocatedFunction) {
            throw new \Storm\Drivers\Pinq\Object\Functional\InvalidFunctionException(
                    'Cannot parse function %s defined in %s on line %d: Two ambiguous functions are defined on the same line, get your shit together',
