...
use \Penumbra\Drivers\Dynamic\Relational;
use \Penumbra\Drivers\Platforms\Null;
use \Penumbra\Drivers\Platforms\Mysql;
use \Penumbra\Drivers\Platforms\Mysql\Tables;
...
class DatabaseBuilder implements IDatabaseBuilder {
   ...
   // </editor-fold>
    ...
    private function BuildDataType(array $ColumnInfoRow) {
        ...
        return new \Penumbra\Drivers\Base\Relational\Columns\DataType($DataTypeName, $DataTypeParameters, $DataTypeExtra);
    }
    // </editor-fold>
}
