    ...
    private static function ReplacementTypes() {
        if(self::$ReplacementTypes === null) {
            self::$ReplacementTypes = [
                \Penumbra\Drivers\Base\Object\Properties\Proxies\IProxy::IProxyType => function (
                        \Penumbra\Drivers\Base\Object\Properties\Proxies\IProxy $Proxy, \ReflectionObject $Reflection, array $TypeReplacementMap, $MaxDepth, $Seen) {
                    $PropertiesToUnset = [];
                    foreach($Reflection->getProperties() as $Property) {
                        if($Property->getDeclaringClass()->implementsInterface(\Penumbra\Drivers\Base\Object\Properties\Proxies\IProxy::IProxyType)) {
                ...
                \Penumbra\Core\Object\IEntityMap::IEntityMapType => null,
                \Penumbra\Drivers\Base\Object\Properties\Proxies\IProxyGenerator::IProxyGeneratorType => null,
            ];
        }
